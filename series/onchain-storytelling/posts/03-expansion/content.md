...
![2023년 12월 기획안. 파일럿 드롭의 작동 흐름. 캐릭터의 계정에서 출발해 스물여덟 개의 재단 패턴을 조합하고, 만들어진 셔츠가 다시 캐릭터의 계정으로 보내지는 순환.](https://kiheonshin.github.io/blog-post-assets/series/onchain-storytelling/assets/deck/mx-slide-03.jpg)
*2023년 12월 기획안. 파일럿 드롭의 작동 흐름. 캐릭터의 계정에서 출발해 스물여덟 개의 재단 패턴을 조합하고, 만들어진 셔츠가 다시 캐릭터의 계정으로 보내지는 순환.*
...
![2024년 1월. 세계관 설정에서 트랜스미디어화까지의 다섯 단계, 그 아래 캐릭터와 라이브러리와 호텔, 그리고 현실 세계의 콘텐츠와 유틸리티와 공간.](https://kiheonshin.github.io/blog-post-assets/series/onchain-storytelling/assets/deck/st-slide-06.jpg)
*2024년 1월. 세계관 설정에서 트랜스미디어화까지의 다섯 단계, 그 아래 캐릭터와 라이브러리와 호텔, 그리고 현실 세계의 콘텐츠와 유틸리티와 공간.*

호텔이라는 은유는 장식이 아니라 동선이었다. 리셉션에서 체크인을 하고, 체크인할 때 수트케이스에서 아이템을 고르고, 번호가 붙은 방을 배정받고, 키오스크에서 무언가를 사고, 배경에는 현실을 미러링하는 날씨와 날짜와 시간이 흐른다. 채널 네 개가 실시간으로 상영되는 화면 구성까지 잡혀 있었다. 관람의 동선이 아니라 투숙의 동선이다. 방문객은 관객이 아니라 투숙객이고, 투숙객은 서비스를 받는 동시에 그 호텔의 이야깃거리가 된다. 앞선 편의 언어로 옮기면, 체크인이 곧 빈 자리에 들어오는 절차였다.
...
![2023년 12월. 음악 유통 구조. 아티스트와 큐레이터와 리스너의 세 자리, 그리고 큐레이션을 묶는 플레이리스트 계정.](https://kiheonshin.github.io/blog-post-assets/series/onchain-storytelling/assets/deck/sg-slide-01.jpg)
*2023년 12월. 음악 유통 구조. 아티스트와 큐레이터와 리스너의 세 자리, 그리고 큐레이션을 묶는 플레이리스트 계정.*
...
![2023년 12월. 미술 갈래. 두 시기로 나뉜 아트웍과 포탈, 그리고 익명의 창조자를 추적하는 새 캐릭터의 자리.](https://kiheonshin.github.io/blog-post-assets/series/onchain-storytelling/assets/deck/sg-slide-03.jpg)
*2023년 12월. 미술 갈래. 두 시기로 나뉜 아트웍과 포탈, 그리고 익명의 창조자를 추적하는 새 캐릭터의 자리.*
