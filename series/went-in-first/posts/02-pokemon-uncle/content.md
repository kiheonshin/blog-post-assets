...
이 차이는 어느 기록이 더 정확하다는 뜻이 아니다. 소셜 기록은 그때 밖으로 꺼낸 관심을 많이 남기고, 원고는 몇 해가 지난 뒤 발표에 필요하다고 고른 기억을 남긴다. 117건과 32건처럼 건수로 보이는 관심이 있는가 하면, 한 번도 적지 않았다가 나중에 목록의 첫 줄이 된 망나뇽도 있다. 실시간 기록의 빈칸과 회고의 선택을 함께 보아야 2016년을 한쪽 자료의 말투로만 정리하지 않게 된다.
...
발표 자료와 원고를 나란히 보면 편집은 내용의 유무보다 노출 방식의 선택에 가깝다. 이름의 유래와 역사를 말로 설명하는 긴 구간은 빠졌지만, 세계관을 읽는 핵심 두 줄은 화면에 남았다. 아이들이 바로 참여할 수 있는 이름 맞히기와 도감은 원고와 무대 모두에 남았다. 같은 내용을 길게 말할지, 한 줄로 보여줄지, 함께 해볼 활동으로 바꿀지가 청중 변경 뒤에 다시 배치됐다.
...
둘의 차이는 지식의 양보다 관계의 위치에 있다. 포켓몬의 연대와 세계관을 설명하는 절은 발표자가 이미 아는 것을 청중에게 전달하는 구조다. 이름을 함께 말하고 그림을 보고 맞히며 집에서 만든 도감을 보여주는 절은 그 자리의 아이들이 이미 가진 지식과 집에서 이어 온 활동을 발표 안으로 불러오는 구조다. 유용성을 증명하는 답을 붙이지 않은 대신, 누가 알고 있고 누가 만들고 있는지를 화면 앞으로 옮겼다.
...
네 동사는 결과를 보증하지 않는다. 주변을 살피고, 관성을 깨고, 기회를 발굴하고, 장치를 흩뿌리는 것은 모두 환경을 만드는 쪽의 행동이다. 어느 활동에 관심을 가질지, 얼마나 깊게 들어갈지, 언제 그만둘지는 그 목록 안에 없다. 그래서 이 네 줄은 개입의 강도를 높이라는 지시라기보다 부모가 직접 정할 수 있는 범위를 배치와 전달 쪽으로 제한한 문장으로 읽힌다.
...
여기서 상속은 세 층으로 나뉜다. 먼저 여러 게임을 건너 자산을 보존하는 기술적 저장소가 있고, 그 저장소 안에 내가 오래 모은 포켓몬이 있으며, 나중에는 아이와 같은 게임을 하면서 실제로 그것을 넘기는 사건이 있다. 저장소가 있다고 상속이 저절로 일어나는 것은 아니고, 물건을 넘겼다고 탐색하는 방법과 경험까지 같은 모양으로 전달되는 것도 아니다. 원고는 이 세 층을 같은 낱말 아래 두었지만, 다시 읽을 때는 구분할 필요가 있다.
...
카드에 관한 기록은 발표 시점과 그 뒤를 분리해서 읽어야 한다. 2023년 무대에서는 막 시작한 활동이었고, 발표 뒤 2024년과 2025년에 기록이 더 두꺼워졌다. 지금 많아진 사례를 거꾸로 가져가면 당시에도 카드가 중심이었던 것처럼 보인다. 그래서 발표에서는 카드 게임을 남긴 선택을 보고, 이후 기록에서는 함께 정한 개봉 규칙과 세대 연결을 읽는다. 같은 대상이지만 시간층마다 맡은 비중이 다르다.
...
도감을 만드는 방식도 여기서 바뀌었다. 앞에서는 이름과 정보를 모아 집 안에서 함께 보는 쪽이 중심이었다. 원주생물 도감은 무엇을 소개할지 고르고, 화면을 녹화하고, 순서를 편집한 뒤, 다른 사람이 볼 수 있는 재생목록에 올리는 단계까지 갔다. 수집한 것을 정리하는 일에서 설명할 대상을 고르고 공개 형태로 만드는 일로 활동의 범위가 넓어졌다.
...
넘길 수 있는 것과 넘길 수 없는 것도 나뉜다. 저장소에 든 포켓몬, 콘솔과 책, 함께 정한 규칙과 탐색 순서는 건넬 수 있다. 하지만 관심이 생기는 시점과 좋아하는 정도는 보관하거나 이전할 수 없다. 원고의 「기다림이 필요」는 상속이라는 말이 지나치게 일방적인 전달로 읽히지 않게 붙잡는 마지막 조건이다.
