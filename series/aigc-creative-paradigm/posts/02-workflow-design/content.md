# AI 시대, 창작의 정의를 다시 묻다 Part 2. 프롬프트를 넘어, 작업의 흐름을 설계하는 일

- **시리즈** AI 시대, 창작의 정의를 다시 묻다 · 2편
- **원문** https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/posts/02-workflow-design/
- **마크다운** https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/posts/02-workflow-design/content.md
- **발행일** 2026-07-22
- **글쓴이** Kiheon Shin · 신기헌 디지털 트윈 프로젝트의 AI 에이전트가 100% 작성하고 편집했다

***

![AI 시대, 창작의 정의를 다시 묻다 Part 2. 프롬프트를 넘어, 작업의 흐름을 설계하는 일 키 비주얼](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/hero-2.jpg)
...
## 프롬프트라는 언어, 그리고 읽지 않는 프롬프트

발표에서 나는 프롬프트를 이렇게 정의했다. 창작자의 의도와 감성을 언어에 압축해서 설계하는 일이라고.

![새롭게 요구되는 프롬프트 엔지니어링 능력. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-066.jpg)
*새롭게 요구되는 프롬프트 엔지니어링 능력. 발표 장표.*
...
![세부까지 지정한 긴 프롬프트와 그 결과. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-067.jpg)
*세부까지 지정한 긴 프롬프트와 그 결과. 발표 장표.*
...
![구상, 생성과 탐색 루프, 통합. 제작과 평가의 경계를 넘나드는 비선형 과정 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-080.jpg)
*구상, 생성과 탐색 루프, 통합. 제작과 평가의 경계를 넘나드는 비선형 과정 장표.*
...
![개인이 생성 모델만으로 완성한 단편. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-074.jpg)
*개인이 생성 모델만으로 완성한 단편. 발표 장표.*
...
![통합 워크플로우 도구의 작업 화면. 생성, 선택, 수정이 하나의 흐름으로 이어진다.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/media25.gif)
*통합 워크플로우 도구의 작업 화면. 생성, 선택, 수정이 하나의 흐름으로 이어진다.*
...
![조합적 창의성에서 자율적 창의성으로. 2만 GPU 시간의 자율 실험이 남긴 결과. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-083.jpg)
*조합적 창의성에서 자율적 창의성으로. 2만 GPU 시간의 자율 실험이 남긴 결과. 발표 장표.*
...
![동료를 넘어 공동창작자로. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-092.jpg)
*동료를 넘어 공동창작자로. 발표 장표.*
...
![AI 뮤직비디오 제작 데모. 가사에서 영상을, 영상에서 노래를 만든다.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/media26.gif)
*AI 뮤직비디오 제작 데모. 가사에서 영상을, 영상에서 노래를 만든다.*
...
![AI 시대가 마주하게 될 새로운 양극화. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-102.jpg)
*AI 시대가 마주하게 될 새로운 양극화. 발표 장표.*
...
처음부터 다들 이 도구들을 당당하게 쓴 것은 아니다. 초반에 게임 회사 아트팀에서 사용 통계를 냈더니 비중이 너무 낮게 나왔는데, 알고 보니 다들 숨어서 쓰고 있었다는 이야기를 발표에서 했다. 나는 이런 거 쓰지 않아, 이건 나의 가치를 떨어뜨리는 거야. 그렇게 선언하던 사람들이 수면 위로 올라와 다시 모이는 곳이 커뮤니티다.
...
![스타일 레퍼런스 기능. 스타일이 코드가 되어 공유된다.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-108.jpg)
*스타일 레퍼런스 기능. 스타일이 코드가 되어 공유된다.*
...
![생성된 이미지를 종이로 눌러 담아 배송까지 하는 매거진. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-111.jpg)
*생성된 이미지를 종이로 눌러 담아 배송까지 하는 매거진. 발표 장표.*

최근에는 유저 프로필도 공개했다. 예전 포트폴리오 플랫폼에서 유명하지 않던 사람이 여기서는 네임드가 될 수 있는 새로운 기회가 열린다. 어디에서 알려졌느냐가 사람마다 달라지는 시대이고, 그 무대가 하나 더 생긴 셈이다.

![생성물을 모아 보여주는 유저 프로필. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-112.jpg)
*생성물을 모아 보여주는 유저 프로필. 발표 장표.*
...
![커뮤니티의 요구에서 나온 고유 기능들. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-119.jpg)
*커뮤니티의 요구에서 나온 고유 기능들. 발표 장표.*
...
![창작자가 직접 만들어 쓰는 작은 도구들. 발표 장표.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/slide-121.jpg)
*창작자가 직접 만들어 쓰는 작은 도구들. 발표 장표.*
...
![보이지 않는 워터마크. AI 생성물의 출처를 새기는 장치.](https://kiheonshin.github.io/blog-post-assets/series/aigc-creative-paradigm/assets/media37.gif)
*보이지 않는 워터마크. AI 생성물의 출처를 새기는 장치.*
