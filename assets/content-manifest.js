export const contentLibrary = {
  series: [
    ...
    },
    {
      ...
      keywords: ["AIGC", "생성 AI", "워크플로", "생성 환경", "가상 표면"],
      ...
      posts: [
        ...
        },
        {
          ...
          sourceYears: [2025],
          topics: ["가상 세계", "AI와 창작"],
          keywords: ["생성 환경", "가상 표면", "현실과 가상", "시뮬레이션 엔진"],
      ...
      sources: [
        ...
        },
        {
          ...
          sourceYears: [2025],
          topics: ["AI와 창작", "창작 도구", "가상 세계"],
          keywords: ["AIGC", "생성 AI", "생성 환경", "워크플로"],
      ...
      sources: [
        {
          ...
          title: "공개 발표와 자료의 연결",
          description:
            "공개된 발표 영상 다섯 편과 2017~2024년 발표 자료를 사람이 읽는 발표명·영상 시각·원자료 페이지로 이어 붙인 색인. 어느 장표가 어느 발화에 놓였는지, 어디가 재편집 구간인지 구분해 적었다.",
          published: "2026-08-28",
          sourceYears: [2017, 2021, 2022, 2024],
          topics: ["기록과 서사", "현실과 가상"],
          keywords: ["발표 자료", "영상 대조", "원자료", "재편집", "NFT", "웹3"],
          href: "series/metaverse-era/sources/presentations/",
        },
      ],
    },
  ],
