      ...
      sources: [
        {
          ...
          description: "2023.12.08 · 장표 21장. 캐릭터를 화자로 세운 의류 프로젝트의 제안 전문",
        ...
        },
        {
          ...
          description: "2023.12.08 · 장표 22장(원본 24장). 다섯 단계 컨버전스 모델과 TBA 구조, 온체인 히스토리까지 프로젝트 전체의 도식",
          published: "2023-12-08",
          sourceYears: [2023],
          topics: ["기록과 서사", "공동 창작"],
        ...
        },
        {
          ...
          description: "2023 · 장표 8장. 음악·미술 카테고리 적용안과 전체 구조 도식의 영문판·한글판, 사업 포지셔닝",
          published: "2023-12-08",
          sourceYears: [2023],
          topics: ["공동 창작", "IP와 정체성"],
          keywords: ["음악 NFT", "포탈", "포지셔닝", "도식"],
